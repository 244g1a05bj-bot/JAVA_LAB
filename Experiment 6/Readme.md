...
```
# OUTPUT 
![output of Exception Handling Mechanism](ExceptionHandling.png)

# Exp-6b
## Title : Illustrating Match catch clauses
```java
import java.util.Scanner;
...
```
# OUTPUT
![output of Multiple Catch](MultipleCatch.png)
...
```
# OUTPUT 
![Output of Built in Exception](BuiltInException.png)
